        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('jenis-pembayaran.update', $jenisPembayaran) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama" id="nama"
                                    ...
                                    value="{{ old('nama', $jenisPembayaran->nama) }}" required>
                                @error('nama')
                            ...
                            <div>
                                ...
                                <select name="jenjang" id="jenjang"
                                    ...
                                    <option value="TK"
                                        {{ old('jenjang', $jenisPembayaran->jenjang) == 'TK' ? 'selected' : '' }}>TK
                                    </option>
                                    <option value="SD"
                                        {{ old('jenjang', $jenisPembayaran->jenjang) == 'SD' ? 'selected' : '' }}>SD
                                    </option>
                                </select>
                                @error('jenjang')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select name="gender" id="gender"
                                    ...
                                    <option value="ALL"
                                        {{ old('gender', $jenisPembayaran->gender) == 'ALL' ? 'selected' : '' }}>Semua
                                    </option>
                                    <option value="L"
                                        {{ old('gender', $jenisPembayaran->gender) == 'L' ? 'selected' : '' }}>Laki-laki
                                    </option>
                                    <option value="P"
                                        {{ old('gender', $jenisPembayaran->gender) == 'P' ? 'selected' : '' }}>Perempuan
                                    </option>
                                </select>
                                @error('gender')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" name="kelas_min" id="kelas_min" min="1" max="6"
                                    ...
                                    value="{{ old('kelas_min', $jenisPembayaran->kelas_min) }}">
                                @error('kelas_min')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="kelas_max" id="kelas_max" min="1" max="6"
                                    ...
                                    value="{{ old('kelas_max', $jenisPembayaran->kelas_max) }}">
                                @error('kelas_max')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="gelombang" id="gelombang"
                                    ...
                                    <option value="1"
                                        {{ old('gelombang', $jenisPembayaran->gelombang) == '1' ? 'selected' : '' }}>
                                        Gelombang 1</option>
                                    <option value="2"
                                        {{ old('gelombang', $jenisPembayaran->gelombang) == '2' ? 'selected' : '' }}>
                                        Gelombang 2</option>
                                    <option value="3"
                                        {{ old('gelombang', $jenisPembayaran->gelombang) == '3' ? 'selected' : '' }}>
                                        Gelombang 3</option>
                                    <option value="4"
                                        {{ old('gelombang', $jenisPembayaran->gelombang) == '4' ? 'selected' : '' }}>
                                        Gelombang 4</option>
                                </select>
                                @error('gelombang')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select name="tipe" id="tipe"
                                    ...
                                    <option value="bulanan"
                                        {{ old('tipe', $jenisPembayaran->tipe) == 'bulanan' ? 'selected' : '' }}>
                                        Bulanan</option>
                                    <option value="tahunan"
                                        {{ old('tipe', $jenisPembayaran->tipe) == 'tahunan' ? 'selected' : '' }}>
                                        Tahunan</option>
                                    <option value="sekali"
                                        {{ old('tipe', $jenisPembayaran->tipe) == 'sekali' ? 'selected' : '' }}>Sekali
                                        Bayar</option>
                                </select>
                                @error('tipe')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" name="total_tagihan" id="total_tagihan"
                                    ...
                                    value="{{ old('total_tagihan', $jenisPembayaran->total_tagihan) }}" required>
                                @error('total_tagihan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
